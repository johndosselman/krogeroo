class Product {
  constructor(data) {
    ...
    this.curbside = data.items[0]?.fulfillment?.curbside;
    this.delivery = data.items[0]?.fulfillment?.delivery;
    this.inStore = data.items[0]?.fulfillment?.inStore;
    this.shipToHome = data.items[0]?.fulfillment?.shipToHome;
